...
System System( / )
{
  ...
  Process VisualizationLogProcess(loggerMean)
    {
      VariableReferenceList [_ Variable:/CellA:A]
                            [_ Variable:/CellA:B]
                            [_ Variable:/CellA:C]
                            [_ Variable:/CellD/Membrane:LIPID]
