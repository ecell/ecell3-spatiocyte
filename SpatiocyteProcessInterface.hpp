...
public:
  ...
  virtual void addSubstrateInterrupt(Species*, unsigned) = 0;
  virtual void removeSubstrateInterrupt(Species*, unsigned) = 0;
  virtual void setLatticeProperties(std::vector<unsigned>*,
