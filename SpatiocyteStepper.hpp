...
public: 
  ...
  Species* id2species(unsigned);
  Comp* id2Comp(unsigned);
...
private:
  ...
  void concatenateVoxel(unsigned&, unsigned, unsigned, unsigned);
  void concatenateLayers(unsigned&, unsigned, unsigned, unsigned, unsigned);
  void concatenateRows(unsigned&, unsigned, unsigned, unsigned, unsigned);
  void concatenateCols(unsigned&, unsigned, unsigned, unsigned, unsigned);
  ...
  bool isSurfaceVoxel(unsigned&, unsigned, Comp*);
  bool isLineVoxel(unsigned&, unsigned, Comp*);
  bool isEnclosedSurfaceVoxel(unsigned&, unsigned, Comp*);
  bool isEnclosedRootSurfaceVoxel(unsigned&, unsigned, Comp*, Comp*);
  bool isPeerMol(unsigned, Comp*);
  bool isLowerPeerMol(unsigned, Comp*);
  bool isRootSurfaceVoxel(unsigned&, unsigned, Comp*);
  bool isParentSurfaceVoxel(unsigned&, unsigned, Comp*);
