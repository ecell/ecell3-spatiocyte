...
theSimulator.createEntity('Variable', 'Variable:/Soma:Kinesin').Value = 19
...
micro.FileName = "twoNeurites.dat"
...
for i in range(4):
  ...
  Histogram.FileName = "hislog.twoNeurites.Neurite%d.csv" %i
  Histogram.LogEnd = 190000
