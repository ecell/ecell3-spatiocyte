...
micro.VariableReferenceList = [['_', 'Variable:/Soma:MTKinesin', '-1']]
micro.VariableReferenceList = [['_', 'Variable:/Soma:MTKinesin', '-1']]
micro.VariableReferenceList = [['_', 'Variable:/Soma:MTKinesin', '12000']]
micro.LogInterval = 1
micro.ExposureTime = 60
micro.FileName = "kAxon.dat"
...
Aold = rotatePointAlongVector(Aold, somaMTvectorZpoint, somaMTvectorZ, angle)
B = rotatePointAlongVector(Aold, somaMTvectorZpoint, somaMTvectorZ, angle*2)
...
neuritesLengthX = [neuriteLength*2, neuriteLength, neuriteLength, neuriteLength]
