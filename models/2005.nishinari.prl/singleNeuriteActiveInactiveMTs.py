...
longestLength = 0
for i in range(len(completedLengths)):
  if(completedLengths[i] > longestLength):
    longestLength = completedLengths[i]
    longestIndex = i
...
#micro.FileName = "microKinesin_actD8_kon2.586e-22-23_koff0.25.dat"
...
Histogram.FileName = "SingleNeurite.HisLog.csv"
