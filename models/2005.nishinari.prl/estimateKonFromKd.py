...
theSimulator.createEntity('Variable', 'Variable:/:MTKinesin' ).Value = 331939
...
iterate.FileName = "IterateLog331939p0.128nr.csv"
iterate.LogEnd = 30
iterate.LogStart = 1
...
#micro.FileName = "microKinesin_D8_p0.1_k0.25.dat"
