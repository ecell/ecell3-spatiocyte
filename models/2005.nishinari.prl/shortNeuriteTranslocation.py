...
theSimulator.createEntity('Variable', 'Variable:/Soma:Kinesin').Value = 16
...
micro.FileName = "shortNeurites.dat"
...
for i in range(4):
  ...
  Histogram.FileName = "hislog.shortNeurites.Neurite%d.csv" %i
  Histogram.LogEnd = 880000
