...
theSimulator.createEntity('Variable', 'Variable:/Soma:Kinesin').Value = 17
...
micro.FileName = "shortNeuriteAxon.dat"
...
for i in range(4):
  ...
  Histogram.FileName = "hislog.shortNeuriteAxon.Neurite%d.csv" %i
