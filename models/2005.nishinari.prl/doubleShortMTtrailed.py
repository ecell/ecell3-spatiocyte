...
theSimulator.createEntity('Variable', 'Variable:/:ROTATEZ').Value = 0
...
theSimulator.createEntity('Variable', 'Variable:/:Kinesin').Value = 1
...
visualLogger.VariableReferenceList = [['_', 'Variable:/:Kinesin', '10300']]
visualLogger.VariableReferenceList = [['_', 'Variable:/:actTubulin']]
visualLogger.VariableReferenceList = [['_', 'Variable:/:MTKinesin', '10300']]
visualLogger.VariableReferenceList = [['_', 'Variable:/:MTKinesinATP', '10300']]
