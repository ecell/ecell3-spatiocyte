...
completedLen = len(completedLengths)
activeIndices = random.sample(xrange(completedLen), int(completedLen*ActivePercent/100.0))
...
theSimulator.createEntity('Variable', 'Variable:/:actMTKinesin' ).Value = 0
theSimulator.createEntity('Variable', 'Variable:/:actMTKinesinATP' ).Value = 0
...
#visualLogger.VariableReferenceList = [['_', 'Variable:/:actMTKinesin' ]]
#visualLogger.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP' ]]
...
#micro.VariableReferenceList = [['_', 'Variable:/:actMTKinesin', '1']]
#micro.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP', '1']]
#micro.VariableReferenceList = [['_', 'Variable:/:MTKinesin', '-1']]
#micro.VariableReferenceList = [['_', 'Variable:/:MTKinesinATP', '-1']]
#micro.VariableReferenceList = [['_', 'Variable:/:MTKinesin', '-1']]
#micro.VariableReferenceList = [['_', 'Variable:/:MTKinesinATP', '-1']]
#micro.ExposureTime = 0.1
#micro.FileName = "microKinesin_actD8_kon2.586e-22-23_koff0.25_active0.15_300.dat"

#clogger = theSimulator.createEntity('CoordinateLogProcess', 'Process:/:clog')
#clogger.VariableReferenceList = [['_', 'Variable:/:GFP', '1']]
...
react = theSimulator.createEntity('DiffusionInfluencedReactionProcess', 'Process:/:actDetachPlus')
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesin','-1']]
react.VariableReferenceList = [['_', 'Variable:/:TubulinP','-1']]
react.VariableReferenceList = [['_', 'Variable:/:Kinesin','1']]
react.VariableReferenceList = [['_', 'Variable:/:TubulinP','1']]
react.p = 1
...
react = theSimulator.createEntity('DiffusionInfluencedReactionProcess', 'Process:/:actExplicitAttach')
react.VariableReferenceList = [['_', 'Variable:/:Kinesin','-1']]
...
react = theSimulator.createEntity('SpatiocyteTauLeapProcess', 'Process:/:actDetach')
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP','-1']]
react.VariableReferenceList = [['_', 'Variable:/:Kinesin','1']]
react.SearchVacant = 1
react.k = 0.25
...
react = theSimulator.createEntity('SpatiocyteTauLeapProcess', 'Process:/:actHydrolysis')
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP','-1']]
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesin','1']]
react.SearchVacant = 1
react.k = 100
...
react = theSimulator.createEntity('SpatiocyteTauLeapProcess', 'Process:/:actPhosphorylate')
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesin','-1']]
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP','1']]
react.SearchVacant = 1
react.k = 145
...
react = theSimulator.createEntity('SpatiocyteTauLeapProcess', 'Process:/:actRatchet')
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesin','-1']]
react.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP','1']]
react.BindingSite = 1
react.k = 55
...
diffuse = theSimulator.createEntity('DiffusionProcess', 'Process:/:actDiffusePlus')
diffuse.VariableReferenceList = [['_', 'Variable:/:actMTKinesin']]
diffuse.D = 0.04e-12
...
Histogram.VariableReferenceList = [['_', 'Variable:/:actMTKinesin' ]]
Histogram.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP' ]]
Histogram.RotateZ = RotateAngle
Histogram.Length = dendriteLength
Histogram.Radius = dendriteRadius
Histogram.Bins = 20
Histogram.LogInterval = 1
Histogram.FileName = "SingleNeurite.HisLog_p%d_t%d_i%d.csv" %(ActivePercent, Duration, Iteration)
Histogram.LogEnd = Duration
...
for i in range(len(completedLengths)):
  ...
  if(i not in activeIndices):
    ...
    Microtubule.VariableReferenceList = [['_', 'Variable:/:actMTKinesin' ]]
    Microtubule.VariableReferenceList = [['_', 'Variable:/:actMTKinesinATP' ]]
    Microtubule.VariableReferenceList = [['_', 'Variable:/:actTubulin' , '-1']]
