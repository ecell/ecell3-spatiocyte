...
theSimulator.createEntity('Variable', 'Variable:/Surface:PG').Value = 377
theSimulator.createEntity('Variable', 'Variable:/Surface:PGs').Value = 0
theSimulator.createEntity('Variable', 'Variable:/Surface:PG_MinD').Value = 23
...
diffuser.D = 10e-12
diffuser.Priority = 10
diffuser.Propensity = 1

rotator = theSimulator.createEntity('RotationProcess', 'Process:/:rotateMinD')
...
fil.Filaments = 20
fil.Subunits = 20
fil.SubunitRadius = 3e-9
fil.SubunitAngle = 1.2
